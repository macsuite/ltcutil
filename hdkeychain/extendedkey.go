...
//   https://github.com/machinecoin/bips/blob/master/bip-0032.mediawiki
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := macutil.Hash160(k.pubKeyBytes())[:4]
...
// Address converts the extended key to a standard machinecoin pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*macutil.AddressPubKeyHash, error) {
	pkHash := macutil.Hash160(k.pubKeyBytes())
	return macutil.NewAddressPubKeyHash(pkHash, net)
}
