...
A Block defines a machinecoin block that provides easier and more efficient
...
A Tx defines a machinecoin transaction that provides more efficient manipulation of
...
To decode/encode an address:
	...
	addr, err := macutil.DecodeAddress(addrString, defaultNet)
	if err != nil {
		fmt.Println(err)
		return
	}
