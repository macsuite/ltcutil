...
// Block defines a machinecoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (macutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (macutil.Tx) for all
...
// instead provides easy access to wrapped versions (macutil.Tx) of them.
...
// NewBlock returns a new instance of a machinecoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a machinecoin block given the
...
// NewBlockFromReader returns a new instance of a machinecoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a machinecoin block given
