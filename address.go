...
import (
	...
	"github.com/macsuite/macutil/bech32"
)
...
// and netID which encodes the machinecoin network and address type.  It is used
...
//
// The machinecoin network the address is associated with is extracted if possible.
...
// https://github.com/machinecoin/bips/blob/master/bip-0173.mediawiki
