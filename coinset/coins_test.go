...
import (
	...
	"github.com/macsuite/macutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    macutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() macutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value macutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = macutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = macutil.NewTxFromBytes(testSimpleCoinTxBytes)
